 ...
 */
(function(){
  var EXPECTED='60f4bacc8b4ce65a04cfe190b1bfc4df28caa23244bfa8ac94569df6916c482f';
  if(sessionStorage.getItem('hb_auth')===EXPECTED){return;}
  document.documentElement.style.visibility='hidden';
  document.addEventListener('DOMContentLoaded',function(){
    document.documentElement.innerHTML='<head><meta charset=utf-8><meta name=viewport content="width=device-width,initial-scale=1"><title>Hyperbots — auth required</title><style>'
    ...
    +'.box{max-width:380px;margin:0 auto;background:#fff;border:1px solid #E2ECEE;border-radius:12px;padding:36px 32px;box-shadow:0 2px 8px rgba(33,31,38,.06);border-left:4px solid #1B7DA7}'
    +'h1{font-size:20px;margin:0 0 6px;color:#07658D;font-weight:600}'
    +'p.s{font-size:13px;color:#748081;margin:0 0 22px}'
    +'input{width:100%;padding:11px 14px;border:1px solid #BDDFEE;border-radius:8px;font-size:14px;margin-bottom:12px;outline:none;background:#F6F9F9;box-sizing:border-box}'
    +'input:focus{border-color:#1B7DA7;background:#fff}'
    +'button{width:100%;padding:11px;background:#1B7DA7;color:#fff;border:0;border-radius:8px;font-size:14px;font-weight:600;cursor:pointer}'
    ...
    +'</style></head>'
    +'<body><div class="box"><h1>🏛️ Hyperbots content hub</h1><p class="s">Password required</p>'
