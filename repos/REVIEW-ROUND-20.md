# Review round-20 aggregate report
...
- `/repos/hyperapi-classify-trade-allocation-method/blog.html`
- `/repos/hyperapi-classify-trade-confirmation-asset-class/blog.html`
- `/repos/hyperapi-classify-trade-confirmation-vs-appraisal-report/blog.html`
- `/repos/hyperapi-classify-trade-confirmation-vs-cover-page/blog.html`
- `/repos/hyperapi-classify-trade-document-presentation-type/blog.html`
- `/repos/hyperapi-classify-trade-finance-doc-class/blog.html`
- `/repos/hyperapi-classify-trade-finance-document-purpose/blog.html`
- `/repos/hyperapi-classify-trade-finance-document-stage/blog.html`
- `/repos/hyperapi-classify-trade-finance-document-stage-type/blog.html`
- `/repos/hyperapi-classify-trade-finance-document-type/blog.html`
...
- Greenlight round-20 (next 50) on a new sub-agent thread.