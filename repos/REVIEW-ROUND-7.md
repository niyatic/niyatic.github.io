# Review round-7 aggregate report
...
- `/repos/hyperapi-classify-escrow-instruction-type-ru/blog.html`
- `/repos/hyperapi-classify-escrow-instruction-type-tr/blog.html`
- `/repos/hyperapi-classify-escrow-instruction-type-zh-hans/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type-ar/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type-de/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type-es/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type-fr/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type-hi/blog.html`
- `/repos/hyperapi-classify-escrow-release-condition-type-it/blog.html`
...
- Greenlight round-7 (next 50) on a new sub-agent thread.